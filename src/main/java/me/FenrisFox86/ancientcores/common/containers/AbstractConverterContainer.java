package me.FenrisFox86.ancientcores.common.containers;

import me.FenrisFox86.ancientcores.common.containers.containerSlots.ConversionFuelSlot;
import me.FenrisFox86.ancientcores.common.containers.containerSlots.ConversionResultSlot;
import me.FenrisFox86.ancientcores.common.recipes.AbstractConversionRecipe;
import me.FenrisFox86.ancientcores.common.tileentities.AbstractConverterTileEntity;
...
public abstract class AbstractConverterContainer<T extends AbstractConverterTileEntity> extends Container {
    ...
    public boolean isFuel(ItemStack p_217058_1_) {
        return net.minecraftforge.common.ForgeHooks.getBurnTime(p_217058_1_) > 0;
    }
