package me.FenrisFox86.ancientcores.common.recipes;
...
public class CrushingRecipe extends AbstractConversionRecipe {

    public static final AbstractConversionRecipe.Serializer<CrushingRecipe> SERIALIZER = new AbstractConversionRecipe
            .Serializer<CrushingRecipe>("crushing", CrushingRecipe::new);
    ...
    public CrushingRecipe(ResourceLocation id, Ingredient input, Item output_item, int min_output, int max_output, float chance) {
    ...
    @Override
    public IRecipeType<?> getType() { return RecipeInit.CRUSHING_RECIPE; }
