...
import me.FenrisFox86.ancientcores.common.items.SingleHandedSwordItem;
...
public class CoreKatana extends SingleHandedSwordItem implements ICoreItem {

    public final String name;
    public final AbstractCoreItem core;

    public CoreKatana(AbstractCoreItem core, int attackDamageIn, float attackSpeedIn) {
        super(core.itemTier, attackDamageIn, attackSpeedIn, new Properties().tab(AncientCores.MOD_TAB));
        this.name = core.name + "_katana";
        this.core = core;
    }
