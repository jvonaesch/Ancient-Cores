...
public class BlockInit {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, AncientCores.MOD_ID);
    ...
    public static RegistryObject<Block> addBlock(String name, Block block) {
        return addBlock(name, block, new Item.Properties().tab(AncientCores.MOD_TAB));
    }
